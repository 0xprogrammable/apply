...
function validateConfig(value) {
  ...
  if (value.activeIntake.baseBranch !== "main" || value.activeIntake.directory !== "submissions" || value.activeIntake.repository !== "0xprogrammable/programmable-registry") {
