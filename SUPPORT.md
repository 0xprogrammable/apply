...
Use the [issue chooser](https://github.com/0xprogrammable/submit-launch/issues/new/choose) for reproducible checker defects,
review-rule gaps, intake failures, registry or schema problems, and documentation errors. Include the affected Submit a Launch
release or commit, exact command, sanitized output, and a minimal public reproduction when possible.

Use [Submit a Launch Discussions](https://github.com/0xprogrammable/submit-launch/discussions) for architecture questions and unfamiliar
...
Use [private vulnerability reporting](https://github.com/0xprogrammable/submit-launch/security/advisories/new) for
